					...
					<div class="col-lg-8">
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql = "SELECT *, user.uname FROM `property`, `user` WHERE property.uid=user.uid and CONCAT(city, location, state, title, type, stype, price) LIKE '%$city%'";
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    ...
                                                    <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-primary"></i> <?php echo $row['14'] . " " . $row['15'] . " City";?></span> </div>
