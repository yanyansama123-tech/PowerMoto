	...
	if($pass != $confirm_pass) {
		...
		else
		{
			...
			if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage))
			{
				...
				$sql="INSERT INTO user (uname,uemail,uphone,upass,utype,uimage) VALUES ('$name','$email','$phone','$pass','user','$uimage')";
...
.registerbox-custom .register-right-wrap {
  width: 100%;
  max-width: 340px;
}
.registerbox-custom h1 {
  font-size: 1.7rem;
  font-weight: 600;
  text-align: center;
  margin-bottom: 8px;
}
.registerbox-custom .account-subtitle {
  text-align: center;
  color: #888;
  margin-bottom: 18px;
  font-size: 1rem;
}
.registerbox-custom .form-control {
  height: 50px;
  font-size: 1rem;
  margin-bottom: 18px;
}
.registerbox-custom .btn-success {
...
.registerbox-custom .login-or {
  text-align: center;
  margin: 18px 0 10px 0;
}
.registerbox-custom .or-line {
...
.registerbox-custom .span-or {
  color: #888;
  font-size: 0.95rem;
}
.registerbox-custom .dont-have {
  text-align: center;
  margin-top: 22px;
  font-size: 1rem;
  color: #888;
}
.registerbox-custom .dont-have a {
  color: #2196f3;
                	...
                	<div class="registerbox-custom">
                        <div class="register-right-wrap">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text"  name="phone" class="form-control" placeholder="Your Phone*" minlength="11" maxlength="11">
                                </div>
                                <div class="form-group">
